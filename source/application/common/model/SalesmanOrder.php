...
class SalesmanOrder extends BaseModel
{
    ...
    public static function init()
    {
        ...
        // 监听订单处理事件
        $static = new static;
        Hook::listen('salesman_order', $static);
    }
    ...
    public function goods()
    {
        ...
        return $this->hasMany("app\\{$module}\\model\\SalesmanOrderGoods",'order_id','order_id','order');
    }
    ...
    {
        $module = self::getCalledModule() ?: 'common';
        return $this->hasOne("app\\{$module}\\model\\OrderAddress",'order_id','order_id','order');
    }
    ...
    {
        $module = self::getCalledModule() ?: 'common';
        return $this->belongsTo("app\\{$module}\\model\\Salesman",'user_id','salesman_id','order');
    }
    ...
    public function getStateTextAttr($value, $data)
    {
        ...
        if (in_array($data['order_status'], [20, 30,21])) {
            $orderStatus = [20 => '已取消',21 => '取消申请中', 30 => '已完成'];
