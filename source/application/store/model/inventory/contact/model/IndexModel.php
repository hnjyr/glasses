...
namespace app\store\model\inventory\contact\model;
...
//        dump($query);die();
        ...
        return $this
            ->alias('contact_model')
            ->field('contact_model.*,user.shop_name,glasses_brand.brand_name')
            ->join('glasses_brand','glasses_brand.brand_id = contact_model.brand_id')
    ...
    public function getModel($type = null, $user_id = null , $brand_id = null)
    {
        return $this
            ->alias('contact_model')
...
//        dump($query);
        !empty($query) && $this->setWhere($query);
        // 获取数据列表
        if (!is_null($brand_id) && is_null($type)){
            return $this
                ->alias('contact_model')
                ->field('contact_model.*,user.shop_name,contact_brand.brand_name')
                ->join('contact_brand','contact_brand.brand_id = contact_model.brand_id')
        ...
        }else if (!is_null($brand_id) && !is_null($type)){
            return $this
                ->alias('contact_model')
                ->field('contact_model.*,user.shop_name,contact_brand.brand_name')
                ->join('contact_brand','contact_brand.brand_id = contact_model.brand_id')
