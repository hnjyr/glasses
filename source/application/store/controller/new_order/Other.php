...
use app\store\model\new_order\Other as NewOrderModel;
...
class Other extends Controller
{
    ...
    public function add()
    {
        ...
        if ($data['other_solution_num'] == ''){
            $data['other_solution_num'] = 0;
        }
        if ($data['other_solution_price'] == ''){
            $data['other_solution_price'] = 0;
        }
        if ($data['other_les_num']== ''){
            $data['other_les_num'] = 0;
        }
        if ($data['other_les_price'] == ''){
            $data['other_les_price'] = 0;
        }
        if ($data['discount'] == ''){
            $data['discount'] = 0;
        }
        $data['total'] =
            ($data['other_num'] * $data['other_price']) +
            ($data['other_solution_num'] * $data['other_solution_price']) +
            ($data['other_les_num'] * $data['other_les_price']);
