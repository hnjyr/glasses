...
use app\store\model\inventory\other\model\IndexModel as IndexModel;
...
//        dump($this->postData());die();
        ...
        if ($model->add($data)) {
            return $this->renderSuccess('添加成功', url('inventory.other.model/index&&brand_id='.$data['brand_id']));
        }
