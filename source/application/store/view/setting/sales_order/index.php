                    ...
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <div class="order-list am-scrollable-horizontal am-u-sm-12 am-margin-top-xs">
                                <table width="100%" border="1" cellpadding="0" class="am-table am-table-centered
...
<!--                                        <th>操作</th>-->
                                    ...
                                    <?php /*dump($data[0]['zjtotal']);die();*/  if (!$list->isEmpty()):   foreach ($data as $order):?>


                                        <?php if ($order!=null) {?>
                                        <tr>
                                            <!--<td class="am-text-middle" >
                                                <input type="checkbox" name="checkitem" value="<?/*= $order['sales_num'] */?>">
                                            </td>-->
                                           <!-- <td class="am-text-middle" >
                                                <span class="am-margin-right-lg"><?/*= $order['sales_num'] */?></span>
                                            </td>-->
                                            <td class="am-text-middle" >
                                           ...
                                           <!-- <td class="am-text-middle" >
                                                <span ><?/*= $data[$key]['month_total'] */?> </span>
                                            </td>
                                            <td class="am-text-middle" >
                                            ...
                                            <!--<td class="am-text-middle" >
                                                <div class="tpl-table-black-operation">
                                                    ...
                                                    <a class="tpl-table-black-operation-del" target="_blank"
                                                       href="<?/*= url('setting.sales_order/detail', ['sales_id' => $order['sales_id']]) */?>">
                                                        编辑</a>
                                                </div>
                                            </td>-->
                                        </tr>
