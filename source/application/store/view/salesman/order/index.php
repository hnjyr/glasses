...
<!--                                            </div>-->
                                        ...
                                        <?php if ($i === 1) : $goodsCount = count($order['goods']); ?>
                                            ...
                                            <td class="am-text-middle" rowspan="<?= $goodsCount ?>">
                                                <p><?= $order['real_name'] ?></p>
                                                <p class="am-link-muted">(用户id：<?= $order['salesman_id'] ?>)</p>
                                            </td>
                                            <td class="am-text-middle" rowspan="<?= $goodsCount ?>">
                                            ...
                                            <td class="am-text-middle" rowspan="<?= $goodsCount ?>">
                                                <div class="tpl-table-black-operation">
                                                    <?php if (checkPrivilege('salesman.order/detail')): ?>
                                                        <a class="tpl-table-black-operation-green"
                                                           href="<?= url('salesman.order/detail', ['order_id' => $order['order_id']]) ?>">
                                                            订单详情</a>
                                                    <?php endif; ?>
                                                    <?php if (checkPrivilege(['salesman.order/detail', 'salesman.order/delivery'])): ?>
                                                        <?php if ($order['pay_status']['value'] == 20
                                                            ...
                                                            <a class="tpl-table-black-operation"
                                                               href="<?= url('salesman.order/detail#delivery',
                                                                   ['order_id' => $order['order_id']]) ?>">去发货</a>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    <?php if (checkPrivilege(['salesman.order/detail', 'order.operate/confirmcancel'])): ?>
