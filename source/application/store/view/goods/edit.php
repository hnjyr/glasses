                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    ...
                                    <div class="help-block am-margin-top-sm">
                                        <small>尺寸750x750像素以上，大小2M以下 (可拖拽图片调整显示顺序 默认第一个为分享图)</small>
                                    </div>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">商品买点 </label>
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <textarea class="am-field-valid" rows="8" placeholder="请输入商品买点"
                                              name="goods[selling_point]"><?= $model['selling_point'] ?></textarea>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">商品素材 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-form-file">
                                        <div class="am-form-file">
                                            <button type="button"
                                                    class="upload-files am-btn am-btn-secondary am-radius">
                                                <i class="am-icon-cloud-upload"></i> 选择图片
                                            </button>
                                            <div class="uploader-list am-cf">
                                            <div class="file-item">
                                                    <a href="<?= $model['share'] ?>" title="点击查看大图" target="_blank">
                                                        <img src="uploads/<?= $model['share'] ?>">
                                                    </a>
                                                    <input type="hidden" name="goods[share]"
                                                           value="<?= $model['share_id'] ?>">
                                                    <i class="iconfont icon-shanchu file-item-delete"></i>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[goods_type]" value="1" data-am-ucheck
                                            <?= $model['goods_type'] == 1 ? 'checked' : '' ?> >
                                        经销商
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[goods_type]" value="2" data-am-ucheck
                                            <?= $model['goods_type'] == 2 ? 'checked' : '' ?> >
                                        门店
                                    </label>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">是否通货 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[is_show]" value="0" data-am-ucheck
                                            <?= $model['is_show'] == 0 ? 'checked' : '' ?> >
                                        非通货
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[is_show]" value="1" data-am-ucheck
                                            <?= $model['is_show'] == 1 ? 'checked' : '' ?> >
                                         通货
                                    </label>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">是否新品 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[is_new]" value="0" data-am-ucheck
                                            <?= $model['is_new'] == 0 ? 'checked' : '' ?> >
                                        非新品
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[is_new]" value="1" data-am-ucheck
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">是否为试用装 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[is_try]" value="0" data-am-ucheck
                                            <?= $model['is_try'] == 0 ? 'checked' : '' ?> >
                                        非试用
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[is_try]" value="1" data-am-ucheck
                                            <?= $model['is_try'] == 1 ? 'checked' : '' ?> >
                                        试用
                                    </label>
                                </div>
                            </div>
