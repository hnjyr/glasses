                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">产品标签 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[goods_type]" value="1" data-am-ucheck  checked>
                                        经销商
                                    </label>
                                    <label class="am-radio-inline">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[is_show]" value="0" data-am-ucheck checked>
                                        非通货
                                    </label>
                                    <label class="am-radio-inline">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[is_new]" value="0" data-am-ucheck checked>
                                        非新品
                                    </label>
                                    <label class="am-radio-inline">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[is_try]" value="0" data-am-ucheck checked>
                                        非试用
                                    </label>
                                    <label class="am-radio-inline">
