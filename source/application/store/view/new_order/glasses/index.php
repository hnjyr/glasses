                                    ...
                                    <?php if (!$list->isEmpty()): foreach ($list as $order): ?>
                                        <tr>
                                            ...
                                            <td class="am-text-middle"  style="text-align: left">
                                                <?php if ($order['frame_num'] != 0): ?>
                                                    <span >镜片:(<?= $order['frame'] ?>)*<?= $order['frame_num'] ?> </span>
                                                <?php  endif;?>
                                                <?php if ($order['glasses_cloth_num'] != 0): ?>
                                                    <br><span >镜框:(<?= $order['glasses'] ?>)*<?= $order['glasses_cloth_num'] ?> </span>
                                                <?php  endif;?>
                                            ...
                                            <td class="am-text-middle" >
                                                <div class="tpl-table-black-operation">
                                                    <a class="tpl-table-black-operation-green"
                                                       href="<?= url('new_order/detail', ['order_id' => $order['glasses_id']]) ?>">
                                                        订单详情</a>
                                                    <a class="tpl-table-black-operation-del" target="_blank"
                                                       href="<?= url('new_order/print_order', ['order_id' => $order['glasses_id']]) ?>">
                                                        打印订单</a>
                                                </div>
                                            </td>
                                        </tr>
