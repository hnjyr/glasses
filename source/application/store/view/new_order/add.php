                            ...
                            am-text-nowrap am-margin-bottom-xs" style="table-layout: fixed">
                                            ...
                                            <tr>
                                                ...
                                                <td ><div class="am-u-sm-9 am-u-end">
                                                        <input id="brandInfo" style="float: left;width: 70%;display: none" readonly type="text" class="tpl-form-input" name="frame"
                                                               value=""  >
                                                        <button id="brandBtn"  type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">选镜片</button>
                                                    </div></td>
                                                <td><div class="am-u-sm-9 am-u-end">
                                                        <input  id="now_inventory_num" min="0" type="number" class="tpl-form-input" name="frame_num"
                                                               value="" >
                                                    </div></td>
                                                <td><div class="am-u-sm-9 am-u-end">
                                                        <input id="priceMax" type="number" min="0" class="tpl-form-input" name="frame_price"
                                                               value="" >
                                                    </div></td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%"><div class="am-u-sm-9 am-u-end">
                                                        <input id="glassesInfo" style="float: left;width: 70%;display: none" readonly type="text" class="tpl-form-input" name="glasses"
                                                               value=""  >
                                                        <button id="glassesBtn"  type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myGlassesModal">选镜框</button>
                                                    </div></td>
                                                <td width="25%"><div class="am-u-sm-9 am-u-end">
                                                        <input id="glasses_num" type="number" class="tpl-form-input" name="glasses_cloth_num"
                                                               value="" >
                                                    </div></td>
                                                <td width="25%"><div class="am-u-sm-9 am-u-end">
                                                        <input id="glasses_price" type="number" class="tpl-form-input" name="glasses_cloth_price"
                                                               value="" >
                                                    </div></td>
                                            ...
                                            <tr>
                                                <td width="25%">其他</td>
                                                <td width="25%"><div class="am-u-sm-9 am-u-end">
                                                        <input type="text" class="tpl-form-input" name="other"
                                                               value="" >
                                                    </div></td>
                                                <td width="25%"> <div class="am-u-sm-9 am-u-end">
                                                        <input type="number" class="tpl-form-input" name="glasses_other_num"
                                                               value="" >
                                                    </div></td>
                                                <td width="25%"><div class="am-u-sm-9 am-u-end">
                                                        <input type="number" class="tpl-form-input" name="glasses_other_price"
                                                               value="" >
                                                    </div></td>
