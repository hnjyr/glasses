                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">编辑任务</div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">任务标题 </label>
                            ...
                            <div class="am-form-group" style="display: none">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">任务分类 </label>
                                <div class="am-u-sm-9 am-u-end">
                            ...
                            <div class="am-form-group am-padding-top">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">任务内容 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <!-- 加载编辑器的容器 -->
