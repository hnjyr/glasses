                                        ...
                                        <tr>
                                           ...
                                           <!-- <td class="am-text-middle am-text-left" rowspan="2">
                                            ...
                                            <!--<td class="am-text-middle" >
                                                <span >镜框:<?/*= $order['frame'] */?>*<?/*= $order['frame_num'] */?> </span>
                                                <span >镜片:<?/*= $order['lens'] */?> *<?/*= $order['lens_num'] */?> </span>
                                            </td>-->
                                            <!--<td class="am-text-middle" rowspan="2">
                                                ...
                                                <div class="tpl-table-black-operation">
                                                    ...
                                                    <a class="tpl-table-black-operation-del" target="_blank"
                                                       href="<?= url('order.glasses/print_order', ['order_id' => $order['glasses_id']]) ?>">
                                                        打印订单</a>
                                                    <a class="tpl-table-black-operation-del iteam-del iteam-del-glasses"
                                        ...
                                        <tr>
                                           ...
                                           <!-- <td class="am-text-middle" rowspan="2">
                                            ...
                                            <td class="am-text-middle" rowspan="2">
                                                <div class="tpl-table-black-operation">
                                                    <a class="tpl-table-black-operation-green"
                                                       href="<?= url('order.contact/detail', ['contact_id' => $order['contact_id']]) ?>">
                                                        订单详情</a>
                                                    <a class="tpl-table-black-operation-del" target="_blank"
                                                       href="<?= url('order.contact/print_order', ['contact_id' => $order['contact_id']]) ?>">
                                                        打印订单</a>
                                                    <a class="tpl-table-black-operation-del iteam-del iteam-del-contact "
...
<script>
    $(function () {
        ...
        $('.iteam-del-contact').delete('contact_id', url, '删除后不可恢复，确定要删除吗？');
...
<script>
    $(function () {
        ...
        $('.iteam-del-glasses').delete('glasses_id', url, '删除后不可恢复，确定要删除吗？');
