                                        ...
                                        <div class="am-form-group">
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <?php if (checkPrivilege('order.other/export')): ?>
                                    ...
                                    <?php if (!$list->isEmpty()): foreach ($list as $order): ?>
                                        <tr>
                                            ...
                                            <td class="am-text-middle" style="text-align: left" >
                                                <?php if ($order['other_num'] != 0): ?>
                                                    <span >其他眼镜:(<?= $order['other'] ?>)*<?= $order['other_num'] ?> </span>
                                                <?php  endif;?>
                                                <?php if ($order['other_solution_num'] != 0): ?>
                                                    <br><span >护理液:(<?= $order['other_solution'] ?>)*<?= $order['other_solution_num'] ?> </span>
                                                <?php  endif;?>
                                                <?php if ($order['other_les_num'] != 0): ?>
                                                    <br><span >其他镜盒:(<?= $order['other_les'] ?>)*<?= $order['other_les_num'] ?> </span>
                                                <?php  endif;?>
                                            </td>
                                            <!--<td class="am-text-middle" >
                                            ...
                                            <td class="am-text-middle" >
                                                <div class="tpl-table-black-operation">
                                                    <a class="tpl-table-black-operation-green"
                                                       href="<?= url('order.other/detail', ['order_id' => $order['other_id']]) ?>">
                                                        订单详情</a>
                                                    <a class="tpl-table-black-operation-del" target="_blank"
                                                       href="<?= url('order.other/print_order', ['order_id' => $order['other_id']]) ?>">
                                                        打印订单</a>
                                                    <a class="tpl-table-black-operation-del iteam-del"
                                                       href="javascript:void(0);" data-id="<?= $order['other_id'] ?>">
                                                        删除订单</a>
                                                </div>
                                            </td>
                                        </tr>
            ...
            $(function () {
                ...
                $('.j-export').click(function () {
                    ...
                    if ($('tbody').find('input:checked').length <= 0 || $('tbody').find('input:checked').length == $('input[name="checkitem"]').length){
                        ...
                        window.location = "<?= url('order.other/export') ?>" + '&' + $.urlEncode(data);
                    } else{
                        ...
                        window.location = "<?= url('order.other/exports') ?>" + '&' + $.urlEncode(data);
...
<script>
    $(function () {
        // 删除元素
        var url = "<?= url('order.other/del_order') ?>";
