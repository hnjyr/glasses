...
<div class="layui-form">
    ...
    <table border="1" lay-size="sm" >
        ...
        <tr class="layui-table-cell">
            <td>1</td>
            <td colspan="6">右眼：<?= $list['contact'] ?></td>
            <td>片</td>
            <td colspan="2"><?= $list['contact_num'] ?></td>
            <td colspan="2"><?= $list['contact_price'] ?></td>
        </tr>
        <tr class="layui-table-cell">
            <td>2</td>
            <td colspan="6">左眼：<?= $list['left_contact'] ?></td>
            <td>片</td>
            <td colspan="2"><?= $list['left_contact_num'] ?></td>
            <td colspan="2"><?= $list['left_contact_price'] ?></td>
        </tr>
        <tr class="layui-table-cell">
            <td>3</td>
            <td colspan="6">眼镜液</td>
            <td>个</td>
            <td colspan="2"><?= $list['solution_num'] ?></td>
            <td colspan="2"><?= $list['solution_price'] ?></td>
        </tr>
        <tr class="layui-table-cell">
            <td>4</td>
            <td colspan="6">眼镜盒</td>
            <td>个</td>
            <td colspan="2"><?= $list['contact_les_num'] ?></td>
            <td colspan="2"><?= $list['contact_les_price'] ?></td>
        </tr>
        <tr class="layui-table-cell">
            <td>合计数量</td>
            <td colspan="2"><?= $list['contact_num'] +  $list['left_contact_num'] + $list['solution_num'] + $list['contact_les_num']?></td>
            <td>合计金额</td>
    ...
    <table border="0" lay-size="sm" >
        ...
        <tr class="layui-table-cell" >
            ...
            <td colspan="3.5"  width='65px'>联系电话:<?= $list['mobile'] ?>12345678911</td>
