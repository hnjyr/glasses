                                        ...
                                        <div class="am-form-group">
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <?php if (checkPrivilege('order.contact/export')): ?>
            ...
            $(function () {
                ...
                $('.j-export').click(function () {
                    ...
                    if ($('tbody').find('input:checked').length <= 0 || $('tbody').find('input:checked').length == $('input[name="checkitem"]').length){
                        ...
                        window.location = "<?= url('order.contact/export') ?>" + '&' + $.urlEncode(data);
                    } else{
                        ...
                        window.location = "<?= url('order.contact/exports') ?>" + '&' + $.urlEncode(data);
...
<script>
    $(function () {
        ...
        $('.iteam-del').delete('contact_id', url, '删除后不可恢复，确定要删除吗？');
