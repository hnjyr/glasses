                        ...
                        <div class="widget__order-detail widget-body am-margin-bottom-lg">
                            ...
                            am-text-nowrap am-margin-bottom-xs">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="goods-title"><?= $detail['right_glasses_cloth_price'] ?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>副</td>
                                        <td><span class="goods-title"><?= $detail['right_frame_num'] ?></td>
                                        <td><span class="goods-title"><?= $detail['right_frame_price'] ?></td>

                                    </tr>
                                    <tr>
                                        <td><span>左眼：</span></td>
                                        <td><span class="goods-title"><?= $detail['left_frame'] ?></td>
                                        <td>副</td>
                                        <td><span class="goods-title"><?= $detail['left_frame_num'] ?></td>
                                        <td><span class="goods-title"><?= $detail['left_frame_price'] ?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="goods-title"><?= $detail['glasses_les_price'] ?></td>


                                    </tr>
                                    <tr>
                                        <td>镜布</td>
                                        <td colspan="2"><span class="goods-title"><?= $detail['case'] ?></span></td>
                                        <td>个</td>
                                        <td><span class="goods-title"><?= $detail['glasses_case_num'] ?></span></td>
                                        <td><span class="goods-title"><?= $detail['glasses_case_price'] ?></span><?php ;?></td>

                                    </tr>

                                    <tr>
                                        <td>其他</td>
                                        <td colspan="2"><span class="goods-title"><?= $detail['other'] ?></span></td>
                                        <td>个</td>
                                        <td><span class="goods-title"><?= $detail['glasses_other_num'] ?></span></td>
                                        <td><span class="goods-title"><?= $detail['glasses_other_price'] ?></span><?php ;?></td>
