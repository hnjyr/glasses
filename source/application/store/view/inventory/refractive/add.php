                            ...
                            <div class="widget-body">
                                <fieldset>
                                    <div class="widget-head am-cf">
                                        <div class="widget-title am-fl">新增折射率</div>
                                    </div>
                                    <div class="am-form-group sales">
                                        <label class="am-u-sm-3 am-form-label form-require"> 折射率 </label>
                                        <div class="am-u-sm-9">
                                            <input type="text"  class="tpl-form-input" name="data[refractive_num]"
                                                   value="<?= $data['refractive_num'] ?>" required>
                                        </div>
                                    </div>
                                    <div class="am-form-group sales">
        ...
        <script>
            ...
            $(function () {
                ...
                $form.submit(function () {
                    var refractive_num  = $('input[name="data[refractive_num]').val();
                    var $btn_submit = $('#btn-submit');
                    $btn_submit.attr("disabled", true);
                    $form.ajaxSubmit({
                        type: "post",
                        dataType: "json",
                        data:{refractive_num:refractive_num,type: type,brand_id:brand_id},
                        url: "<?= url('inventory.refractive/add') ?>",
