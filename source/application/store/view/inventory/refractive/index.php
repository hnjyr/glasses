            ...
            <div class="am-fr tpl-header-navbar">
                <ul>
                    ...
                    <li class="am-text-sm tpl-header-navbar-welcome">
                        <a href="<?= url('store.user/renew') ?>">欢迎你，<span><?= $store['user']['user_name'] ?>，<?= $store['user']['user_name']=='admin'?'超级管理员':$store['user']['shop_name']?></span></span>
                        </a>
                    </li>
                    <!-- 退出 -->
                    <li class="am-text-sm">
                                        ...
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <a class="j-export am-btn am-btn-danger am-radius"
                                                   href="<?= url('inventory.refractive/add&&type='.$_GET['type'].'&&brand_id='.$_GET['brand_id']) ?>">
                                        ...
                                        <td class="am-text-middle" >
                                            <div class="tpl-table-black-operation">
                                                <a id="submit1"  class="tpl-table-black-operation"
                                                   href="<?= url('inventory.model/index&&type='.$_GET['type'].'&&brand_id='.$order['brand_id'].'&&refractive_id='.$order['refractive_id']) ?>" style="width:50%;margin: auto">
                                                    型号</a>
