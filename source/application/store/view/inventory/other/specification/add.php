                            ...
                            <div class="widget-body">
                                <fieldset>
                                    <div class="widget-head am-cf">
                                        <div class="widget-title am-fl">新增库存</div>
                                    </div>
            ...
            $(function () {
                ...
                $form.submit(function () {
                    ...
                    $form.ajaxSubmit({
                        type: "post",
                        dataType: "json",
                        data:{model_id:model_id,brand_id:brand_id,price:price,standard_inventory:standard_inventory},
                        url: "<?= url('inventory.other.specification/add') ?>",
