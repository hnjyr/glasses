                                        ...
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <a class="j-export am-btn am-btn-danger am-radius"
                                                   href="<?= url('inventory.contact.specification/add&&type='.$_GET['type'].'&&brand_id='.$_GET['brand_id'].'&&model_id='.$_GET['model_id']) ?>">
                                        ...
                                        <td class="am-text-middle" >
                                            <div class="tpl-table-black-operation">
                                                <a id="submit1"  class="tpl-table-black-operation"
                                                   href="<?= url('inventory.contact.model/index&&type='.$_GET['type'].'&&brand_id='.$order['brand_id']) ?>">
                                                    补充库存</a>
