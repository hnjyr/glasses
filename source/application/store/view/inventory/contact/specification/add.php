                            ...
                            <div class="widget-body">
                                <fieldset>
                                    <div class="widget-head am-cf">
                                        <div class="widget-title am-fl">新增型号</div>
                                    </div>
                                    ...
                                    <div class="am-form-group sales">
                                        <label class="am-u-sm-3 am-form-label form-require"> 度数 </label>
                                        <div class="am-u-sm-9">
                                            <select class="selectpicker show-tick" name="data[degree]" id="">
                                    ...
                                    <div class="am-form-group sales">
                                        <div class="am-u-sm-9 am-u-sm-push-3 am-margin-top-lg">
                                            <button id="btn_submit" type="submit" class="j-submit am-btn am-btn-secondary">提交
                                            </button>
                                        </div>
                                    </div>
                                </fieldset>
        ...
        <script>
            ...
            $(function () {
                ...
                $form.submit(function () {
                    var color  = $('input[name="data[color]').val();
                    var price  = $('input[name="data[price]').val();
                    var degree  = $('select[name="data[degree]').val();
                    var standard_inventory  = $('input[name="data[standard_inventory]').val();
                    ...
                    $form.ajaxSubmit({
                        type: "post",
                        dataType: "json",
                        data:{model_id:model_id,type:type,degree:degree,brand_id:brand_id,color:color,price:price,standard_inventory:standard_inventory},
                        url: "<?= url('inventory.contact.specification/add') ?>",
