    ...
    <div class="tpl-content-wrapper <?= empty($second) ? 'no-sidebar-second' : '' ?>">
        ...
        <script>
            ...
            $(function () {
                ...
                refractive_id = <?=$_GET["refractive_id"]; ?>;
                model_id = <?=$_GET["model_id"]; ?>;
                // 表单提交
                var $form = $('#my-form');
                $form.submit(function () {
                    var price  = $('input[name="data[price]').val();
                    var spherical_lens  = $('select[name="data[spherical_lens]').val();
                    var cytdnder  = $('select[name="data[cytdnder]').val();
                    ...
                    $form.ajaxSubmit({
                        type: "post",
                        dataType: "json",
                        data:{model_id:model_id,type: type,brand_id:brand_id,refractive_id:refractive_id,price:price,spherical_lens:spherical_lens,cytdnder:cytdnder,standard_inventory:standard_inventory},
                        url: "<?= url('inventory.specification/add') ?>",
