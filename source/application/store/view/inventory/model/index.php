                                        ...
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <a class="j-export am-btn am-btn-danger am-radius"
                                                   href="<?= url('inventory.model/add&&type='.$_GET['type'].'&&brand_id='.$_GET['brand_id'].'&&refractive_id='.$_GET['refractive_id']) ?>">
                                                    <i class="iconfont icon-add am-margin-right-xs"></i>新增型号
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <td class="am-text-middle" >
                                            <div class="tpl-table-black-operation">
                                                <a id="submit1"  class="tpl-table-black-operation"
                                                   href="<?= url('inventory.specification/index&&type='.$_GET['type'].'&&brand_id='.$order['brand_id'].'&&refractive_id='.$order['refractive_id'].'&&model_id='.$order['model_id']) ?>" style="width:50%;margin: auto">
                                                    库存规格</a>
