<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:98:"C:\Users\Administrator\Desktop\glasses\web/../source/application/store\view\setting\user\renew.php";i:1601114968;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="widget-body">
                                <fieldset>
                                    ...
                                    <div class="am-form-group renew">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="password" placeholder="请输入8-16位字母+数字+特殊字符组合" class="tpl-form-input" name="user[password]"
                                                   value="" required>
                                        </div>
                                    </div>
                                    <div class="am-form-group renew">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="password" placeholder="请输入8-16位字母+数字+特殊字符组合" class="tpl-form-input" name="user[password_confirm]"
                                                   value="" required>
                                        </div>
                                    </div>
                                    <div class="am-form-group renew">
