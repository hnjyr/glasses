<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"C:\Users\Administrator\Desktop\glasses\web/../source/application/store\view\passport\login.php";i:1601125239;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="container">
    <div id="wrapper" class="login-body">
        <div class="login-content">
            <div class="brand">
                <img alt="logo" class="brand-img" src="assets/store/img/login/logo.png?v=<?php echo '<?'; ?>
/*= $version */?>" style="position: absolute;left: 25%">
