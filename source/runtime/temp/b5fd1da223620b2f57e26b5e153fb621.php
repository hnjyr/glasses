<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:99:"C:\Users\Administrator\Desktop\glasses\web/../source/application/store\view\order\glasses\index.php";i:1601114968;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                        ...
                                        <div class="am-form-group">
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <?php if (checkPrivilege('order.glasses/export')): ?>
                                            ...
                                            <!--<div class="am-form-group am-fl">
                                                <div class="am-input-group am-input-group-sm tpl-form-border-form">
                                                    <input type="text" class="am-form-field" name="shopName"
                                                           placeholder="请输入店铺名" value="<?php echo '<?'; ?>
                                            ...
                                            <div class="am-form-group am-fl">
                                                <div class="am-input-group am-input-group-sm tpl-form-border-form">
                                                    <input type="text" class="am-form-field" name="search"
                                                           placeholder="请输入订单号/客户名字/客户手机号" value="<?= $request->get('search') ?>">
                                                    <div class="am-input-group-btn">
                                                        <button class="am-btn am-btn-default am-icon-search"
                                                                type="submit"></button>
                                                    </div>
...
<!--                                        <th>店铺名</th>-->
                                    ...
                                    <tbody>
                                    <?php $colspan = 12; if (!$list->isEmpty()): foreach ($list as $order): ?>
                                        <tr>
...
/*= $order['shop_name'] */?></span>
                                            ...
                                            <td rowspan="2">
                                                ...
                                                <?php  endif;if ($order['glasses_les_num'] != 0): ?>
                                                    <br><span >镜盒:(<?= $order['glasses_les'] ?>)*<?= $order['glasses_les_num'] ?> </span>
                                                <?php  endif;if ($order['glasses_case_num'] != 0): ?>
                                                    <br><span >镜布:(<?= $order['case'] ?>)*<?= $order['glasses_case_num'] ?> </span>
                                                <?php  endif;if ($order['glasses_other_num'] != 0): ?>
            ...
            $(function () {
                ...
                $('.j-export').click(function () {
                    ...
                    if ($('tbody').find('input:checked').length <= 0 || $('tbody').find('input:checked').length == $('input[name="checkitem"]').length){
                        ...
                        window.location = "<?= url('order.glasses/export') ?>" + '&' + $.urlEncode(data);
                    } else{
                        ...
                        window.location = "<?= url('order.glasses/exports') ?>" + '&' + $.urlEncode(data);
...
<script>
    $(function () {
        ...
        $('.iteam-del').delete('glasses_id', url, '删除后不可恢复，确定要删除吗？');
