<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"C:\Users\Administrator\Desktop\glasses\web/../source/application/store\view\index\index.php";i:1601114968;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
    ...
    <link rel="stylesheet" href="//at.alicdn.com/t/font_2028330_ikcyaudpd18.css">
    <link rel="stylesheet" href="//at.alicdn.com/t/font_783249_m68ye1gfnza.css">
    <link rel="stylesheet" href="//at.alicdn.com/t/font_2045680_tj2xv13urw.css">
    <link rel="stylesheet" href="//at.alicdn.com/t/font_2045680_9pkvyd7q6nn.css">

    <script src="assets/common/js/jquery.min.js"></script>
    <script src="//at.alicdn.com/t/font_783249_e5yrsf08rap.js"></script>
    <script src="//at.alicdn.com/t/font_2028330_ikcyaudpd18.js"></script>
    <script src="//at.alicdn.com/t/font_2045680_tj2xv13urw.js"></script>
    <script>
        ...
        <div class="page-home row-content am-cf">
            ...
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12 am-margin-bottom">
                    <div class="widget am-cf"  style="height: 890px">
                        <div class="widget-head">
                            <div class="widget-title">总览</div>
                        </div>
                        <div class="widget-body am-cf">
                            <div class="am-u-sm-12 am-u-md-6 am-u-lg-3" style="display: none">
                            ...
                            <div class="am-u-sm-12 am-u-md-6 am-u-lg-5">
                                <div class="widget-card card__red am-cf" style="">
                                    <div class="card-header">门店总量</div>
                                    <div class="card-body">
                                        <div class="card-value"><?= $data['widget-card']['user_total'] ?></div>
                                        <div class="card-description">当前门店总量</div>
                        ...
                        <div class="widget-body am-cf">
                            <div class="am-u-sm-6 am-u-md-6 am-u-lg-4" style="margin-left: 16%">
                                <div class="widget-outline dis-flex flex-y-center">
                                    ...
                                    <div class="outline-right dis-flex flex-dir-column flex-x-center">
                                        ...
                                        <div class="item-value"><?= $data['widget-echarts']['week_order_total'] ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="am-u-sm-1 am-u-md-1 am-u-lg-4" style="float: left">
                                <div class="widget-outline dis-flex flex-y-center">
                                    <div class="outline-left">
                                    ...
                                    <div class="outline-right dis-flex flex-dir-column flex-x-center">
                                        ...
                                        <div class="item-value"><?= $data['widget-echarts']['week_order_total_price'] ?></div>
                                    </div>
                                </div>
                            </div>
                        </div s>
                        <div class="widget-body am-cf">
                            <div class="am-u-sm-6 am-u-md-6 am-u-lg-4" style="margin-left: 16%">
                                <div class="widget-outline dis-flex flex-y-center">
                                    <div class="outline-left">
                                        <img src="assets/store/img/statistics/survey/06.png" alt="">
                                    </div>
                                    <div class="outline-right dis-flex flex-dir-column flex-x-center">
                                        <div class="item-name">本月订单数</div>
                                        <div class="item-value"><?= $data['widget-echarts']['month_order_total'] ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="am-u-sm-1 am-u-md-1 am-u-lg-4" style="float: left">
                                <div class="widget-outline dis-flex flex-y-center">
                                    <div class="outline-left">
                                        <img src="assets/store/img/statistics/survey/07.png" alt="">
                                    </div>
                                    <div class="outline-right dis-flex flex-dir-column flex-x-center">
                                        <div class="item-name">本月成交额</div>
                                        <div class="item-value"><?= $data['widget-echarts']['month_order_total_price'] ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="widget-body am-cf" >
                            <div class="am-u-sm-6 am-u-md-6 am-u-lg-4" style="margin-left: 16%">
                                <div class="widget-outline dis-flex flex-y-center">
                                    <div class="outline-left">
                                        <img src="assets/store/img/statistics/survey/08.png" alt="">
                                    </div>
                                    <div class="outline-right dis-flex flex-dir-column flex-x-center">
                                        <div class="item-name">本年订单数</div>
                                        <div class="item-value"><?= $data['widget-echarts']['year_order_total'] ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="am-u-sm-1 am-u-md-1 am-u-lg-4" style="float: left">
                                <div class="widget-outline dis-flex flex-y-center">
                                    <div class="outline-left">
                                        <img src="assets/store/img/statistics/survey/09.png" alt="">
                                    </div>
                                    <div class="outline-right dis-flex flex-dir-column flex-x-center">
                                        <div class="item-name">本年成交额</div>
                                        <div class="item-value"><?= $data['widget-echarts']['year_order_total_price'] ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            ...
            echarts.init(dom, 'walden').setOption({
                ...
                legend: {
                    ...
                    data: ['成交量', '成交额'],
                    selectedMode: 'single',//默认开启图例选择，可以设成 false 关闭。除此之外也可以设成 'single' 或者 'multiple' 使用单选或者多选模式。
