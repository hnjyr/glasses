<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:101:"C:\Users\Administrator\Desktop\glasses\web/../source/application/store\view\statistics\data\index.php";i:1601114968;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<!--                                        <option value=""></option>-->
            ...
            <div class="order-list am-scrollable-horizontal am-u-sm-12 am-margin-top-xs">
                ...
                <table width="100%" class="am-table am-table-centered
                    ...
                    <tbody>
                    <?php $colspan = 12;  foreach ($data['month'] as $key => $value): ?>
                        <tr>
            ...
            <div class="order-list am-scrollable-horizontal am-u-sm-12 am-margin-top-xs">
                ...
                <table width="100%" class="am-table am-table-centered
                    ...
                    <tbody>
                    <?php $colspan = 12;  foreach ($data['years'] as $key => $value): ?>
                        <tr>
                            <td class="am-text-middle " >
                                <span class="am-margin-right-lg"><?= $key+1 ?></span>
                            </td>
