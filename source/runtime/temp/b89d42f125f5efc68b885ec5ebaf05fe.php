<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"C:\Users\Administrator\Desktop\glasses\web/../source/application/store\view\order\index\index.php";i:1601114968;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<!--                                        <th>合计金额</th>-->
                                    ...
                                    <tbody>
                                    <?php $colspan = 12; if (!$glassesList->isEmpty()): foreach ($glassesList as $order): ?>
                                        <tr>
...
/*= $order['total'] */?></span>
                                    ...
                                    <?php endforeach; endif; if (!$contactList->isEmpty()): foreach ($contactList as $order): ?>
                                        <tr>
                                            <td class="am-text-middle am-text-left" rowspan="2">
...
/*= $order['shop_name'] */?></span>
                                            ...
                                            <td rowspan="2">
                                                ...
                                                <?php  endif;if ($order['contact_les_num'] != 0): ?>
