<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:101:"C:\Users\Administrator\Desktop\glasses\web/../source/application/store\view\inventory\index\index.php";i:1601114968;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<?php //dump($list);die(); ?>
<head>
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    ...
                    <div class="widget-body am-fr">
                        ...
                        am-text-nowrap am-margin-bottom-xs">
                            ...
                            <tbody>
                            <?php $colspan = 5; if (!$list->isEmpty()): foreach ($list as $order): //dump($order); ?>
                                <tr>
        ...
        methods: {
            ...
            abc() {
              ...
              if(level == 2) {
                ...
                if (that.price!=''&&that.spherical_lens!=''&&that.now_inventory!=''&&that.cytdnder!='') {//添加
                  $.ajax({
                    type: "POST",
